...
import { GameState, GameAction, GamePhase, Territory, GamePlayer, CombatResult, ValidationResult } from '@/types/game';
...
export function createInitialGameState(numPlayers: number, boardSize: number): GameState {
  ...
  // Create players with required properties for GamePlayer
